...
export const FeedActionsMenu: React.FC<FeedActionsMenuProps> = ({
	feed,
	onAction,
}) => {
				...
				createPortal(
					<div
						style={{
							...
							border: "1px solid hsl(var(--border))",
							borderRadius: 10,
							boxShadow: "var(--shadow-pop, 0 8px 32px rgba(0,0,0,0.12))",
							minWidth: 180,
							padding: "6px 4px",
						}}
					>
						...
						{separator}
						{feed.enabled
							? item("Disable feed", "disable")
							: item("Enable feed", "enable")}
						{separator}
