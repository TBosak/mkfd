 ...
 */
export async function storeFeedHistory(
	feedId: string,
	snapshotData: string,
	format = "items_json",
): Promise<void> {
 ...
 */
export async function getPreviousFeedHistory(
	feedId: string,
): Promise<string | null> {
	if (_store) {
 ...
 */
export async function loadDateIndex(
	feedId: string,
 ...
 */
export async function saveDateIndex(
	feedId: string,
 ...
 */
export function makeItemKey<T extends { date?: unknown }>(item: T): string {
